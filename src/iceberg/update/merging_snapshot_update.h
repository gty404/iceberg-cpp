...
///
/// See also: org.apache.iceberg.MergingSnapshotProducer
class ICEBERG_EXPORT MergingSnapshotUpdate : public SnapshotUpdate {
 ...
 protected:
  ...
  // -------------------------------------------------------------------------
  // Primitive API — called by subclasses to describe the desired changes
  // -------------------------------------------------------------------------
  ...
  /// \brief Register a file path to be deleted from the table.
